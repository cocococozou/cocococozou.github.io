...
p1<- mean_ave_df%>%
  ...
  labs(
    title = "Average temperature in January and in July in each station across years",
    x = "Year",
...
p2 <- ny_noaa_df %>% 
  ...
  labs(
    title = "Average precipitation of each month across years",
    x = "Count",
    y = "Mean of precipitation"
  )
